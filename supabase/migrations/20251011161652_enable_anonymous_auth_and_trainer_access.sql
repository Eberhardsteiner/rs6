/*
  ...
  2. Changes
    ...
    - Ensure trainer_memberships table is properly secured
  ...
  4. Tables Affected
    ...
    - trainer_memberships (manage own membership)
*/
...
DROP POLICY IF EXISTS "Trainers can read all players" ON players;
...
DROP POLICY IF EXISTS "Trainers can insert own record" ON players;
...
DROP POLICY IF EXISTS "Trainers can update own record" ON players;
...
DROP POLICY IF EXISTS "Trainers can read games" ON games;
...
DROP POLICY IF EXISTS "Trainers can read all decisions" ON decisions;
...
DROP POLICY IF EXISTS "Trainers can read all messages" ON messages;
...
DROP POLICY IF EXISTS "Trainers can read game settings" ON game_admin_settings;
...
-- ============================================================================
-- TRAINER_MEMBERSHIPS TABLE: Manage trainer access
-- ============================================================================

-- Ensure the table exists (it should from previous migrations)
...
DROP POLICY IF EXISTS "Users can read own trainer memberships" ON trainer_memberships;
...
DROP POLICY IF EXISTS "Users can insert own trainer membership" ON trainer_memberships;
...
DROP POLICY IF EXISTS "Users can delete own trainer membership" ON trainer_memberships;
