...
const TeamCommunicationSection = ({
  ...
  return (
    <div style={{
      ...
      <h3 className="mp-heading" style={{ margin: '0 0 12px 0', color: '#92400e' }}>
...
interface GameOverScreenFullProps {
  state: GameState;
...
export function GameOverScreenFull({
  state,
  finalEnding,
  role,
  kpiEstimates,
