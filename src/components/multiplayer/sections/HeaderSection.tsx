// src/components/multiplayer/sections/HeaderSection.tsx
    ...
    >
      <div style={{ display: 'flex', gap: 24, alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <span title={`Vollständige ID: ${gameId}`}>
            Spiel: <strong>{gameId.substring(0, 8)}...</strong>
          </span>
          <button
        ...
        {isGM && (
          <span style={{ background: '#f59e0b', padding: '2px 8px', borderRadius: 4 }}>
            👑 GM
          </span>
        )}
      </div>
